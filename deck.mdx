...
<div style="font-family: 'VT323', monospace;font-weight:normal;">Jacque Schrag, @jnschrag</div>
...
<ol>
  ...
  <li>Talk will explain how you can use CSS to do this, leveraging Sass to streamline the process</li>
  <li>Since this is a JS conference, I’ll also show you how to use a smidge of JS to make easily editable pixels</li>
</ol>
</Notes>
...
<Notes>
  <ol>
    <li>Let's make a cat. Pusheen pixel from beginning.</li>
    <li>Writing box-shadows by head is tedious & unnecessary</li>
